...
This is an implementation of [FlightMVC](http://todomvc.com/) built using:
...
It is adapted from the [redux FlightMVC example](https://github.com/rackt/redux/tree/master/examples/todomvc).
